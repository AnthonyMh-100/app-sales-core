...
import { getProductStats } from "@/src/actions";
import { ContainerProducts } from "./ui/ContainerProducts";
...
export const ProductsPage = async ({ searchParams }: Props) => {
  ...
  return (
    <div className="bg-gray-100 min-h-screen p-6 md:p-10 md:px-16">
      <div className="mb-6">
        ...
        <ContainerProducts params={params} />
      </div>
    </div>
  );
};
